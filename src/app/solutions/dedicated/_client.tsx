...
export default function DedicatedClient() {
  const [isDedicatedRequestOpen, setIsDedicatedRequestOpen] = useState(false);
  ...
  return (
    <main className="bg-white text-slate-900">
      <section className="mx-auto w-full max-w-7xl px-6 py-12 md:py-16">
        ...
        >
          <AnimateBtn
            onClick={() => setIsDedicatedRequestOpen(true)}
            borderColor="#21445B"
            color="#21445B"
            hoverColor="#ffffff"
            activeColor="#ffffff"
      ...
      >
        <Image
          src="/images/da01.jpg"
          alt="Dedicated assets fleet deployment"
          fill
          priority
          quality={92}
      ...
      <RequestFormModal
        isOpen={isDedicatedRequestOpen}
        onClose={() => setIsDedicatedRequestOpen(false)}
        title="Dedicated Assets Request Form"
      ...
      >
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2 md:gap-8">
          <RequestFormSelect defaultValue="">
            <option value="" disabled>What do you want to move?</option>
            <option>Dedicated Trucks</option>
            <option>Dedicated Warehouse Space</option>
            <option>Dedicated Mixed Assets</option>
          </RequestFormSelect>
          <RequestFormSelect defaultValue="">
            <option value="" disabled>Est. Monthly Volume E.g 50 tons</option>
            <option>Under 10 tons</option>
            <option>10 - 50 tons</option>
            <option>50+ tons</option>
          </RequestFormSelect>
          <RequestFormSelect defaultValue="">
            <option value="" disabled>Select Primary Route</option>
            <option>Lagos - Ibadan</option>
            <option>Apapa - Kano</option>
            <option>Port Harcourt - Aba</option>
          </RequestFormSelect>
        </div>
        ...
        <div className="mt-4 flex flex-wrap gap-x-10 gap-y-3 text-[14px] font-[300] text-[#607481]">
          <label className="inline-flex items-center gap-3">
            <input type="radio" name="dedicated-urgency" defaultChecked />
            Immediately
          </label>
          <label className="inline-flex items-center gap-3">
            <input type="radio" name="dedicated-urgency" />
            Within a week
          </label>
          <label className="inline-flex items-center gap-3">
            <input type="radio" name="dedicated-urgency" />
